new DataTable('#example', {
    ...
    columnDefs: [
        ...
        { target: 1, visible: true, searchable: true,  responsivePriority:  0}, // nombre Sigla
        { target: 2, visible: true, searchable: true,  responsivePriority:  2}, // Link
        { target: 3, visible: true, searchable: false, responsivePriority:  1}, // Activo
