new DataTable('#example', {
    ...
    columnDefs: [
        ...
        { target: 2, visible: true, searchable: true, responsivePriority: 1 }, // Artista
        { target: 3, visible: true, searchable: false, responsivePriority: 100 }, // Canciones
        { target: 4, visible: true, searchable: true, responsivePriority: 100 }, // Publicación
        { target: 5, visible: true, searchable: false, responsivePriority: 2 }, // Activo
