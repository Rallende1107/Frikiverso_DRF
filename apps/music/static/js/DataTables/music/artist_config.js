new DataTable('#example', {
    ...
    columnDefs: [
        ...
        { target: 1, visible: true, searchable: true, responsivePriority: 0 }, // name
        { target: 2, visible: true, searchable: true, responsivePriority: 50 }, // Años
        { target: 3, visible: true, searchable: false, responsivePriority: 60 }, // Miembros
        { target: 4, visible: true, searchable: false, responsivePriority: 90 }, // Albums
        { target: 5, visible: true, searchable: false, responsivePriority: 100 }, // Tipo
        { target: 6, visible: true, searchable: false, responsivePriority: 1 }, // Activo
