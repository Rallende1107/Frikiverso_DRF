new DataTable('#example', {
    ...
    columnDefs: [
        ...
        { target: 1, visible: true, searchable: true, responsivePriority: 0 }, // full_name pseudonimo
        { target: 2, visible: true, searchable: false, responsivePriority: 3 }, // birth_year
        { target: 3, visible: true, searchable: true, responsivePriority: 5 }, // role
        { target: 4, visible: true, searchable: false, responsivePriority: 4 }, // is_active
        { target: 5, visible: true, searchable: false, responsivePriority: 0 }, // acciones
    ],
});