new DataTable('#example', {
    ...
    columnDefs: [
        ...
        { target: 1, visible: true, searchable: true, responsivePriority: 1 }, // artista
        { target: 2, visible: true, searchable: true, responsivePriority: 3 }, // miembro
        { target: 3, visible: true, searchable: true, responsivePriority: 5 }, // role
        { target: 4, visible: true, searchable: false, responsivePriority: 1 }, // is_active
