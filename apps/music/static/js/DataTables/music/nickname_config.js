new DataTable('#example', {
    ...
    columnDefs: [
        ...
        { target: 1, visible: true, searchable: true, responsivePriority: 1 }, // artista name
        { target: 2, visible: true, searchable: true, responsivePriority: 3 }, // nickname
        { target: 3, visible: true, searchable: false, responsivePriority: 1 }, // is_active
