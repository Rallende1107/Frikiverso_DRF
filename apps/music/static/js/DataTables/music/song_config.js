new DataTable('#example', {
    ...
    columnDefs: [
        ...
        { target: 1, visible: true, searchable: true, responsivePriority: 1 }, // title
        { target: 2, visible: true, searchable: true, responsivePriority: 2 }, // Album Artist
        { target: 3, visible: true, searchable: true, responsivePriority: 3 }, // Lanzamiento
        { target: 4, visible: true, searchable: true, responsivePriority: 1 }, // Activo
