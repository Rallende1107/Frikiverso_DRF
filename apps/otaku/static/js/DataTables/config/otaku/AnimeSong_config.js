new DataTable('#example', {
    ...
    columnDefs: [
        ...
        { target: 1, visible: true, searchable: true, responsivePriority: 3 }, // Anime
        { target: 2, visible: true, searchable: false, responsivePriority: 9 }, // Tipo ID
        { target: 3, visible: true, searchable: true, responsivePriority: 1 }, // Titulo
        { target: 4, visible: true, searchable: true, responsivePriority: 2 }, // Artista
        { target: 5, visible: true, searchable: false, responsivePriority: 1 }, // Activa
