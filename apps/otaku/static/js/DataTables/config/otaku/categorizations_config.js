new DataTable('#example', {
    ...
    columnDefs: [
        ...
        { target: 2, visible: true, searchable: false, responsivePriority: 9 }, // get_num_animes
        { target: 3, visible: true, searchable: false, responsivePriority: 3 }, // get_num_mangas
        { target: 4, visible: true, searchable: false, responsivePriority: 3 }, // is_active
        { target: 5, visible: true, searchable: false, responsivePriority: 3 }, // explicit
