new DataTable('#example', {
    ...
    columnDefs: [
        ...
        { target: 1, visible: true, searchable: true, responsivePriority: 0 }, // Titulo
        { target: 2, visible: true, searchable: false, responsivePriority: 2 }, // Actuales
        { target: 3, visible: true, searchable: false, responsivePriority: 0 }, // Bton
    ],
});