new DataTable('#example', {
    ...
    columnDefs: [
        ...
        { target: 1, visible: true, searchable: true, responsivePriority: 0 }, // Inicial
        { target: 2, visible: true, searchable: true, responsivePriority: 0 }, // Nombre
        { target: 3, visible: true, searchable: true, responsivePriority: 3 }, // Animes
        { target: 4, visible: true, searchable: true, responsivePriority: 3 }, // mangas
        { target: 5, visible: true, searchable: false, responsivePriority: 4 }, // Activo
