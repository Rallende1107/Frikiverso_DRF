new DataTable('#example', {
    ...
    columnDefs: [
        ...
        { target: 2, visible: true, searchable: true, responsivePriority: 1 }, // Extencion
        { target: 3, visible: true, searchable: false, responsivePriority: 2 }, // Anime/Manga
        { target: 4, visible: true, searchable: false, responsivePriority: 0 }, // URL
        { target: 5, visible: true, searchable: false, responsivePriority: 0 }, // URL Web
        { target: 6, visible: true, searchable: false, responsivePriority: 0 }, // Activo
