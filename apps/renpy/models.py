...
class Game(models.Model):
    ...
    developers = models.ManyToManyField(Developer, blank=True, limit_choices_to={'is_active': True}, related_name='games_as_developed', verbose_name=_('Desarrollador'))
    publishers = models.ManyToManyField(Publisher, blank=True, limit_choices_to={'is_active': True}, related_name='games_as_published', verbose_name=_('Editor'))
    ...
    translators = models.ManyToManyField(Translator, blank=True, limit_choices_to={'is_active': True}, related_name='games_as_translated', verbose_name=_('Traductores'))
    genres = models.ManyToManyField(Genre, blank=True, limit_choices_to={'is_active': True}, related_name='games_as_genre', verbose_name=_('Géneros'))
