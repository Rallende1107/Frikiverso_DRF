new DataTable('#example', {
    ...
    columnDefs: [
        ...
        { target: 1, visible: true, searchable: true, responsivePriority: 1 }, // Dev - Trad
        { target: 2, visible: true, searchable: true, responsivePriority: 2 }, // Nombre
        { target: 3, visible: true, searchable: false, responsivePriority: 4 }, // Activo
        { target: 4, visible: true, searchable: false, responsivePriority: 1 }, // Acciones
    ],
});