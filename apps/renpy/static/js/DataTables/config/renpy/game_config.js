new DataTable('#example', {
    ...
    columnDefs: [
        ...
        { target: 1, visible: true, searchable: true, responsivePriority: 1 }, // Nombre
        { target: 2, visible: true, searchable: true, responsivePriority: 2 }, // Desarrollador
        { target: 3, visible: true, searchable: true, responsivePriority: 100 }, // Versión
        { target: 4, visible: true, searchable: true, responsivePriority: 100 }, // Fecha Lanzamiento
        { target: 5, visible: true, searchable: true, responsivePriority: 3 }, // Estado
        { target: 6, visible: true, searchable: false, responsivePriority: 4 }, // Activo
        { target: 7, visible: true, searchable: false, responsivePriority: 1 }, // Acciones
    ],
});