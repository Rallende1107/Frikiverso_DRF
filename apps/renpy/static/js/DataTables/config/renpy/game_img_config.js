new DataTable('#example', {
    ...
    columnDefs: [
        ...
        { target: 1, visible: true, searchable: true, responsivePriority: 1 }, // juego
        { target: 2, visible: true, searchable: true, responsivePriority: 5 }, // nombre
        { target: 3, visible: true, searchable: true, responsivePriority: 4 }, // extencion
        { target: 4, visible: true, searchable: true, responsivePriority: 2 }, // ver
        { target: 5, visible: true, searchable: true, responsivePriority: 3 }, // activo
