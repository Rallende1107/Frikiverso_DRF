new DataTable('#example', {
    ...
    columnDefs: [
        ...
        { target: 1, visible: true, searchable: true, responsivePriority: 10 }, // Nombre
        { target: 2, visible: true, searchable: false, responsivePriority: 90 }, // Juegos
        { target: 3, visible: true, searchable: false, responsivePriority: 80 }, // Explicito
        { target: 4, visible: true, searchable: false, responsivePriority: 10 }, // Activo
